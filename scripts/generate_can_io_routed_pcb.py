...
def main() -> None:
    ...
    tail = [
        ...
        f'  (zone (net {NET_ID["POWER_GND"]}) (net_name "POWER_GND") (layer "F.Cu") (tstamp {uid("gnd-zone-top")}) (hatch edge 0.5) (connect_pads full (clearance 0.25)) (min_thickness 0.25) (fill yes (thermal_gap 0.3) (thermal_bridge_width 0.3) (island_removal_mode 0)) (polygon (pts (xy 20.5 20.5) (xy 115.5 20.5) (xy 115.5 105.5) (xy 20.5 105.5))))',
