 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --size 80 --bpp 4 --format lvgl --font .pio\libdeps\waveshare_5\lvgl\scripts\built_in_font\Montserrat-Medium.ttf -r 0x20,0x2B-0x2E,0x30-0x39 --no-compress --no-prefilter --lv-fallback lv_font_montserrat_24 --lv-font-name dash_numeric_80 -o src\ui\fonts\dash_numeric_80.c
 ******************************************************************************/
...
#ifndef DASH_NUMERIC_80
#define DASH_NUMERIC_80 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 745, .box_w = 37, .box_h = 36, .ofs_x = 5, .ofs_y = 11},
    {.bitmap_index = 666, .adv_w = 291, .box_w = 12, .box_h = 23, .ofs_x = 3, .ofs_y = -12},
    {.bitmap_index = 804, .adv_w = 490, .box_w = 23, .box_h = 7, .ofs_x = 4, .ofs_y = 19},
    {.bitmap_index = 885, .adv_w = 291, .box_w = 12, .box_h = 12, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 957, .adv_w = 854, .box_w = 47, .box_h = 58, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2320, .adv_w = 474, .box_w = 22, .box_h = 56, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2936, .adv_w = 735, .box_w = 43, .box_h = 57, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4162, .adv_w = 732, .box_w = 43, .box_h = 57, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5388, .adv_w = 856, .box_w = 50, .box_h = 56, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 6788, .adv_w = 735, .box_w = 43, .box_h = 57, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 8014, .adv_w = 790, .box_w = 45, .box_h = 58, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 9319, .adv_w = 765, .box_w = 43, .box_h = 56, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 10523, .adv_w = 824, .box_w = 45, .box_h = 58, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 11828, .adv_w = 790, .box_w = 44, .box_h = 58, .ofs_x = 2, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t dash_numeric_80 = {
#else
lv_font_t dash_numeric_80 = {
#endif
